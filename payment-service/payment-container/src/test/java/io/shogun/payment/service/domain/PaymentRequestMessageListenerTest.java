...
import io.shogun.payment.service.dataaccess.outbox.entity.OrderOutboxEntity;
...
import io.shogun.payment.service.domain.ports.input.message.listener.PaymentRequestMessageListener;
...
import static io.shogun.saga.order.SagaConstants.ORDER_SAGA_NAME;
...
public class PaymentRequestMessageListenerTest {
    ...
    private PaymentRequest getPaymentRequest(String sagaId) {
        return PaymentRequest.builder()
                ...
                .paymentOrderStatus(io.shogun.domain.valueobject.PaymentOrderStatus.PENDING)
