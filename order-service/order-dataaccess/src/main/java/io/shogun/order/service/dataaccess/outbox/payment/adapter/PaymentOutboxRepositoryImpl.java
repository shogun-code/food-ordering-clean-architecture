package io.shogun.order.service.dataaccess.outbox.payment.adapter;

import io.shogun.order.service.dataaccess.outbox.payment.exception.PaymentOutboxNotFoundException;
import io.shogun.order.service.dataaccess.outbox.payment.mapper.PaymentOutboxDataAccessMapper;
import io.shogun.order.service.dataaccess.outbox.payment.repository.PaymentOutboxJpaRepository;
import io.shogun.order.service.domain.outbox.model.payment.OrderPaymentOutboxMessage;
import io.shogun.order.service.domain.ports.output.repository.PaymentOutboxRepository;
