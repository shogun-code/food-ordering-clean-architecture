package io.shogun.order.service.dataaccess.outbox.restaurantapproval.adapter;

import io.shogun.order.service.dataaccess.outbox.restaurantapproval.exception.ApprovalOutboxNotFoundException;
import io.shogun.order.service.dataaccess.outbox.restaurantapproval.mapper.ApprovalOutboxDataAccessMapper;
import io.shogun.order.service.dataaccess.outbox.restaurantapproval.repository.ApprovalOutboxJpaRepository;
import io.shogun.order.service.domain.outbox.model.approval.OrderApprovalOutboxMessage;
import io.shogun.order.service.domain.ports.output.repository.ApprovalOutboxRepository;
